...
class FPANet_NoSaim(nn.Module):
    ...
    def __init__(self, pretrain=False, num_classes=1):
        ...
        self.out4 = nn.Sequential(nn.Conv2d(64, num_classes, kernel_size=(3,3), padding=1))
        self.out3 = nn.Sequential(nn.Conv2d(64, num_classes, kernel_size=(3,3), padding=1))
        self.out2 = nn.Sequential(nn.Conv2d(64, num_classes, kernel_size=(3,3), padding=1))
        self.out1 = nn.Sequential(nn.Conv2d(64, num_classes, kernel_size=(3,3), padding=1))
